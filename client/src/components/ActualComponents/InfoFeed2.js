...
const InfoFeed2 = ({ setSelectedExercise,selectedExercise, handleToggleSidebar }) => {
  ...
  return (
    <div className='selection2 info-feed info-feed2 .show-sidebar'>
